        ...
        <div className="relative">
          ...
          {userMenuOpen && (
            <div className="absolute right-0 mt-2 w-48 bg-primary text-primary-foreground rounded-md shadow-lg">
              <Link to="/profile" className="block px-4 py-2 text-primary-foreground hover:bg-secondary hover:text-secondary-foreground">Profile</Link>
              <Link to="/settings" className="block px-4 py-2 text-primary-foreground hover:bg-secondary hover:text-secondary-foreground">Settings</Link>
              <Link to="/logout" className="block px-4 py-2 text-primary-foreground hover:bg-secondary hover:text-secondary-foreground">Log Out</Link>
            </div>
          )}
        </div>
      </nav>
