...
const ProjectCard = ({project}: ProjectCardProps) => {
    return<div className="bg-white w-2/3 max-h-50 rounded-lg border-2 border-border px-4 py-4 flex duration-300 hover:shadow-lg hover:shadow-gray-300 hover:border-purple-700">
        ...
        <div className="mx-2 w-full p-2">
            <h2 className="text-4xl mb-3">{project.title}</h2>
                    <p className="text-base text-left">{truncater(project.description as string, 400)}</p>
                </div>
